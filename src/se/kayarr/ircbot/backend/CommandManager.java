...
public class CommandManager {
	...
	//*** This needs to be replaced to make each bot instance have a separate CommandManager
	...
	private Command findMatchingCommand(String command) {
		for(Command cmd : registeredCommands) {
			if(cmd.matchesCommandString(command)) return cmd;
		}
		
		return null;
	}
	
	public boolean dispatchCommand(PircBotX bot, Channel channel, User user, String command, String parameters) {
